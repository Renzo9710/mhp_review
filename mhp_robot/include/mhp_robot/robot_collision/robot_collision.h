...
class RobotCollision
{
 public:
    ...
    // MB Variants implemented by Anonymized and modified for speed by Anonymized
    // TODO(anonym) This function does not work correctly for some cases. The reason might be the closest point assumption.
